  ...
  <header id="header">
    ...
    <div class="container">
      ...
      <div class="logo float-left">
        ...
        <h1 class="text-light"><a href="#intro" class="scrollto"><span>Kamar Koding</span></a></h1>
    ...
    <div class="container d-flex h-100">
      <div class="row justify-content-center align-self-center">
        <div class="col-md-6 intro-info order-md-first order-last">
          <h2>Mari Ngoding<br>Bersama <span>Kami!</span></h2>
          <div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-md-6">
            <div class="about-content">
              <h2>Tentang Kami</h2>
              <h3>Media belajar berbasis website yang fokus untuk meningkatkan skill untuk bisa menjadi seorang programmer.</h3>
              <p>Kamar Koding memungkinkan kamu untuk berbagi hal yang kamu tahu dan juga kamu akan mendapatkan wawasan seputar web development, pemrograman dan teknologi informasi lainnya.</p>
              <p>Belajar membuat website dan aplikasi. Bingung mulai dari mana? Tenang, mari bergabung bersama Ribuan teman lainnya. Mau bekerja sebagai programmer atau membuat karya, kamu juga bisa!</p>
              <ul>
                <li><i class="ion-android-checkmark-circle"></i> Belajar Mudah karna materi yang disampaikan didesain untuk mudah dipahami.</li>
                <li><i class="ion-android-checkmark-circle"></i> Harga Kelas nya murah.</li>
    ...
    <section id="why-us" class="wow fadeIn">
      <div class="container-fluid">
        ...
        <header class="section-header">
          ...
          <p>Kamar koding punya jurus spesial nih yang bikin kalian ingin berlangganan ke Kamar Koding.</p>
        </header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-9 text-center text-lg-left">
            <h3 class="cta-title">Bergabung Kamar Koding?</h3>
            <p class="cta-text"> yuk sudahi sedihmu, mari ngoding bersama kami.</p>
          </div>
          ...
          <div class="col-lg-8">
            ...
            <div class="owl-carousel testimonials-carousel wow fadeInUp">
              ...
              <div class="testimonial-item">
                ...
                <h4>SMA Kelas 3</h4>
                <p>
                 Ternyata setelah belajar di kamar koding aku baru tau kalo ngoding seseru ini. jadi langsung ingin menjadi Programmer, terima kasih Kamar Koding.
                </p>
              </div>
              ...
              <div class="testimonial-item">
                ...
                <p>
                  Terima Kasih Kamar Koding, Karna belajar disini ku jadi mudah ngerjain tugas tugas dari dosen.
                </p>
              </div>
    ...
    <section id="faq">
      <div class="container">
        <header class="section-header">
          ...
          <p>dibawah ini adalah pertanyaan yang sering ditanyakan ke team kamar koding</p>
        </header>

        <ul id="faq-list" class="wow fadeInUp">
          <li>
            <a data-toggle="collapse" class="collapsed" href="#faq1">apa itu Kamar Koding? <i class="ion-android-remove"></i></a>
            <div id="faq1" class="collapse" data-parent="#faq-list">
              <p>
                Kamar Koding adalah Media belajar berbasis website yang fokus untuk meningkatkan skill untuk bisa menjadi seorang programmer.
              </p>
            </div>
          </li>

          <li>
            <a data-toggle="collapse" href="#faq2" class="collapsed">Diajarkan apa aja sih di Kamar Koding? <i class="ion-android-remove"></i></a>
            <div id="faq2" class="collapse" data-parent="#faq-list">
              <p>
               di Kamar Koding kakak bisa kompeten sesuai minat kakak, dari front end developer, backend developer, UI/UX, Data Analyst dan semua yang berhubungan dengan Informatic Engineering.
              </p>
            </div>
          </li>

          <li>
            <a data-toggle="collapse" href="#faq3" class="collapsed">Mahal gak harga kelas Di Kamar Koding? <i class="ion-android-remove"></i></a>
            <div id="faq3" class="collapse" data-parent="#faq-list">
              <p>
                Tentu tidak kak, di Kamar Koding menawarkan kelas kelas yang tentunya murah yang harganya mulai dari 20 Ribu Loh
              </p>
            </div>
          </li>
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="footer-info">
                    <h3>Kamar Koding</h3>
                    <p>Kamar Koding adalah Media belajar berbasis website yang fokus untuk meningkatkan skill untuk bisa menjadi seorang programmer.</p>
                  </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="footer-links">
                    ...
                    <p>
                      ...
                      <strong>Email:</strong> kamarkoding@gmail.com<br>
                    </p>
                  </div>
          ...
          <div class="col-lg-6">
            ...
            <div class="form">
              ...
              <h4>Kirim Pesan ke Kamar Koding</h4>
              <p>Jika ingin bertanya lebih lanjut tentang kamar koding bisa dengan mengisi form di bawah ya!</p>
